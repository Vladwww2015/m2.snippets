 ...
 */
namespace Brander\BenefitsBlock\Block\Adminhtml\Helper\Form;
...
class Gallery extends AbstractBlock
{
     ...
     * @var string
     */
    protected $fieldNameSuffix = 'benefit';
     ...
     * @var string
     */
    protected $name = 'benefit[media_gallery]';
     ...
     * @var string
     */
    protected $formName = 'benefit_form';
